...
public class JdbcUserDAOTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "mattymattmattcat", "$2a$10$Nw1szXQbDHdsZ0UMGwDYuuj11LV.4KadomqE9qGDkTMxwK11x93xa", "user");
    protected static final User USER_2 = new User(2, "evenstephen", "$2a$10$sNsoK44rCWny3PZhArEAquufjxedqO9wME4NcyjBv2MUj8KNSJhci", "user");
    private static final User USER_3 = new User(3, "codythegoat", "$2a$10$C9/OkOaFoKH6PR3nEfy26OTKb4WI3Gxv9tv.QkPaSXiW1ISBDGXwe", "user");
